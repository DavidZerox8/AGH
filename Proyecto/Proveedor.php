...
<?php
  ...
  //Abrimos la conexion.
    ...
    if(isset($_POST['btcGuardar']))
    {
      ...
      $sql="INSERT INTO proveedor VALUES('".$idProveedor."','".$organizacion."','".$direccion."','".$telefono."','".$email."')";
                  ...
                  <form method="post">
                    <fieldset>
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input name="idProveedor" id="idProveedor"  type="text" class="form-control input-sm">
                      </div>
                      <div class="form-group col-lg-6">
