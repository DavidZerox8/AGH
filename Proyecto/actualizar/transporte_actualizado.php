<?php
  //Abrimos la conexion.
    ...
    $actualizacion = "UPDATE transporte SET marca='".$marca."',modelo='".$modelo."',numSerie='".$noSerie."',placas='".$noPlacas."',diasCircula='".$dCirculacion."' ";
       
    mysql_query($actualizacion)or die("<H3>Error al actualizar</H3>". mysql_error());
    //realizamos la consulta a la tabla correspondiente.
    $query = "SELECT * FROM transporte ORDER BY id_transporte";
...
<head>
  ...
  <script>
    ...
    function obtenerId(celda){
      idTrans = document.getElementById('idTrans');
      idTrans.value = celda.innerHTML;
      document.formActualizarTrans.submit();
    }

    function obtenerIdDelete(celda){
      idTransporteDelete = document.getElementById('idTransporteDelete');
      idTransporteDelete.value = celda.innerHTML;
     var resp = confirm("¿Esta seguro de eliminar el Transporte?");
      if (resp) {
        document.formDeleteTrasnporte.submit();
      }else{
        return false;
      }
    }
              ...
              <section class="panel">
                <header class="panel-heading">
                  ...
                  <span class="pull-right">
                    <a href="../Transporte.php" class="btn btn-success btn-xs">Crear Transporte</a>
                  </span>
                </header>
                <div class="panel-body">
                  ...
                  <form action="../actualizar/actualizar_transporte.php" method="post" name="formActualizarTrans">
                        <input type="hidden" name="idTrans" id="idTrans"/>
                  </form>
                  <form action="../eliminados/borrar_Transporte.php" method="post" name="formDeleteTrasnporte">
                        <input type="hidden" name="idTransporteDelete" id="idTransporteDelete"/>
                  </form>
                </div>
              </section>
            </div>
