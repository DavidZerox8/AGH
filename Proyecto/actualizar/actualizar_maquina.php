...
<?php
  ...
  //Abrimos la conexion.
   ...
   require_once '../conexion/Conexion.php';
    ...
    //echo $NoReporte;
    $Consulta = "SELECT * FROM maquina where id_maq ='" . $idMaquina . "'";
            ...
            <div class="col-lg-12">
              <section class="panel">
                ...
                <div class="panel-body">
                  <form action="maquina_actualizada.php"  method="post" name="myform">
                  <?php
                ...
                // echo $numero;
                    ...
                    <fieldset>
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input name="IdMaquina" id="IdMaquina" type="text" class="form-control input-sm" value="<?php echo $datos[0]; ?>">
                      </div>
                      <div class="form-group col-lg-6">
                        <label>Nombre</label>
                        <input name="nombre" id="nombre" type="text" class="form-control input-sm" value="<?php echo $datos[1]; ?>">
                      </div>
                      <div class="form-group col-lg-6">
                        <label>Micraje</label>
                        <input name="micraje" id="micraje" type="text" class="form-control input-sm" value="<?php echo $datos[3]; ?>">
                      </div>
                      ...
                      <input type="hidden" name="idMaquinaMod" id="idMaquinaMod" value="<?php echo $datos[0]; ?>"/>
