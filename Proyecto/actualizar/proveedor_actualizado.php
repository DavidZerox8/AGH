  ...
  //Abrimos la conexion.
    require_once '../conexion/Conexion.php';
     ...
     // Obtenemos los valores que insertaremos
      $idProveedorMod = $_POST["idProveedorMod"];
      ...
      $actualizacion = "UPDATE proveedor SET Organizacion='".$organizacion."',direccion='".$direccion."',telefono='".$telefono."',email='".$email."' where id_proveedor = '".$idProveedorMod."' ";
...
<head>
  ...
  <script>
    ...
    function obtenerId(celda){
      idEtiqueta = document.getElementById('idProveedor');
      idEtiqueta.value = celda.innerHTML;
      document.formActualizarProve.submit();
    }
  </script>
  </head>
              ...
              <section class="panel">
                <header class="panel-heading">
                  ...
                  <span class="pull-right">
                    <a href="../Proveedor.php" class="btn btn-success btn-xs">Crear Proveedor</a>
                  </span>
                </header>
                <div class="panel-body">
                  ...
                  <form action="../actualizar/actualizar_proveedor.php" method="post" name="formActualizarProve">
