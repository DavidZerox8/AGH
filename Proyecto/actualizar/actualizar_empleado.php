...
<?php
  ...
  //Abrimos la conexion.
   require_once '../conexion/Conexion.php';
    ...
    echo($idemp);
    //echo $NoReporte;
    $Consulta = "SELECT * FROM Empleado where id_emp ='" . $idemp . "'";
            ...
            <div class="col-lg-12">
              <section class="panel">
                ...
                <div class="panel-body">
                  <form action="empleado_actualizado.php"  method="post" name="myform">
                    ...
                    <fieldset>
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input name="IdEmp" id="IdEmp" type="text" class="form-control input-sm" value="<?php echo $datos[0]; ?>">
                      </div>
                      <div class="form-group col-lg-6">
                        <label>Nombre(s)</label>
                        <input name="nombre" id="nombre" type="text" class="form-control input-sm" value="<?php echo $datos[0]; ?>">
                      </div>
                      <div class="form-group col-lg-6">
                        <label>Apellido Paterno</label>
                        <input name="apPaterno" id="apPaterno" type="text" class="form-control input-sm" value="<?php echo $datos[0]; ?>">
                      </div>
                      <div class="form-group col-lg-6">
                        <label>Apellido Mterno</label>
                        <input name="apMaterno" id="apMaterno" type="text" class="form-control input-sm" value="<?php echo $datos[0]; ?>">
                      </div>
                     <div class="form-group border-bottom-grey margin-bottom-30">
                        <h5>
                          <strong>
                      ...
                      <div class="form-group col-lg-12">
                        ...
                        <input name="fNacimiento" id="fNacimiento" type="text" class="form-control input-sm" value="<?php echo $datos[0]; ?>">
                      </div>
                      ...
                      <input type="hidden" name="idEmpleadoMod" id="idEmpleadoMod" />
