...
<?php
  ...
  //Abrimos la conexion.
   require_once '../conexion/Conexion.php';
    ...
    //echo $NoReporte;
    $Consulta = "SELECT * FROM transporte where id_transporte ='" . $idTrans . "'";
            ...
            <div class="col-lg-12">
              <section class="panel">
                ...
                <div class="panel-body">
                  <form action="transporte_actualizado.php"  method="post" name="myform">
                  <?php
                ...
                // echo $numero;
                    ...
                    <fieldset>
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input name="IdTransporte" id="IdTransporte" type="text" class="form-control input-sm" value="<?php echo $datos[0]; ?>">
                      </div>
                      <div class="form-group col-lg-6">
                        <label>Marca</label>
                        <input name="marca" id="marca" type="text" class="form-control input-sm" value="<?php echo $datos[3]; ?>">
                      </div>
                      <div class="form-group col-lg-6">
                        <label>Modelo</label>
                        <input name="modelo" id="modelo" type="text" class="form-control input-sm" value="<?php echo $datos[4]; ?>">
                      </div>
                      <div class="form-group col-lg-6">
                        <label>No. Serie</label>
                        <input name="noSerie" id="noSerie" type="text" class="form-control input-sm" value="<?php echo $datos[5]; ?>">
                      </div>
                      <div class="form-group col-lg-6">
                        <label>No. Placas</label>
                        <input name="noPlacas"  id="noPlacas" type="text" class="form-control input-sm" value="<?php echo $datos[5]; ?>">
                      </div>
                      <div class="form-group col-lg-6">
                        <label>Días Circulación</label>
                        <input name="dCirculacion" id="dCirculacion"  type="text" class="form-control input-sm" value="<?php echo $datos[7]; ?>">
                      </div>
                      <div class="form-group border-bottom-grey margin-bottom-30">
                        <h5>
                          <strong>
                     ...
                     <input type="hidden" name="idTranMod" id="idTranMod" value="<?php echo $datos[0]; ?>"/>
