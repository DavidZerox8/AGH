  ...
  //Abrimos la conexion.
    require_once '../conexion/Conexion.php';
     ...
     // Obtenemos los valores que insertaremos
      $idEtiqueta = $_POST["idEtiquetaMod"];
      ...
      $actualizacion = "UPDATE etiqueta SET id_maq='".$maquina."',id_material='".$material."',nombre='".$descripccion."',marca='".$marca."',ancho='".$ancho."',alto='".$alto."',acabado='".$acabado."',tipoTrabajo='".$tTrabajo."',presentacion='".$presentacion."' where id_etiq='".$idEtiqueta."' ";
            ...
            <div class="col-lg-12">
              <section class="panel">
                <header class="panel-heading">
                  Consulta de Etiqueta <?php echo($noEtqieta)?>.
                ...
                <div class="panel-body">
                  ...
                  <form action="../actualizar/actualizar_producto.php" method="post" name="formActualizarProd">
                   ...
                   <form action="../eliminados/borrar_etiqueta.php" method="post" name="formDeleteProd">
