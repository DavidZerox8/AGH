  ...
  //Abrimos la conexion.
    require_once '../conexion/Conexion.php';
     ...
     // Obtenemos los valores que insertaremos
      $idMaterial = $_POST["idMaterialMod"];
      ...
      echo ($material);
      $actualizacion = "UPDATE material SET cantidad='".$cantidad."',descripcion='".$descripccion."',presentacion='".$presentacion."',unidadMedida='".$unidadMedida."' where id_material='".$idMaterial."' ";
...
<head>
  ...
  <script>
    ...
    function obtenerId(celda){
      idEtiqueta = document.getElementById('idMaterial');
      idEtiqueta.value = celda.innerHTML;
      document.formActualizarMat.submit();
    }
  </script>
  </head>
              ...
              <section class="panel">
                <header class="panel-heading">
                  ...
                  <span class="pull-right">
                    <a href="../Registro_material.php" class="btn btn-success btn-xs">Crear Material</a>
                  </span>
                </header>
                <div class="panel-body">
                  ...
                  <form action="../actualizar/actualizar_material.php" method="post" name="formActualizarMat">
