            ...
            <div class="col-lg-12">
              <section class="panel">
                ...
                <div class="panel-body">
                  <form method="post" action="jsp/a_PedidoProveedor.jsp">
                    <fieldset>
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input name="no_pedido_proveedor" id="IdTransporte" type="text" class="form-control input-sm">
                      </div>
                      <div class="form-group col-lg-6">
                        <label>No.Proveedor	</label>
                        <input name="no_proveedor" id="marca" type="text" class="form-control input-sm">
                      </div>
                      <div class="form-group col-lg-6">
                        <label>No. Material</label>
                        <input name="no_material" id="modelo" type="text" class="form-control input-sm">
                      </div>
                      <div class="form-group col-lg-6">
                     ...
                     <div class="form-group  pull-right">
                        <input type="button" name="btcCancel" value="Cancelar" class="btn btn-danger btn-sm" onClick=" window.location.href='../menu.jsp'">
                      </div>
                       <div class="form-group  pull-right">
