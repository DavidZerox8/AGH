            ...
            <div class="col-lg-12">
              <section class="panel">
                ...
                <div class="panel-body">
                  <form method="post" action="jsp/a_Cliente.jsp">
                    <fieldset>
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input name="no_cliente" id="no_cliente" type="text" class="form-control input-sm">
                      </div>
                      <div class="form-group col-lg-6">
                        <label>Empresa</label>
                        <input name="empresa" id="empresa" type="text" class="form-control input-sm">
                      </div>
                      <div class="form-group col-lg-6">
                        <label>Razon Social</label>
                        <input name="rasonZocial" id="rZocial" type="text" class="form-control input-sm">
                      </div>
                      <div class="form-group col-lg-6">
                        <label>R.F.C</label>
                        <input name="rfc" id="rfc" type="text" class="form-control input-sm">
                      </div>
                      <div class="form-group col-lg-6">
                        <label>Domicilio</label>
                        <input name="domicilio" id="domicilio" type="text" class="form-control input-sm">
                      </div>
                      <div class="form-group col-lg-6">
